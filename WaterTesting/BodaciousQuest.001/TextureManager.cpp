...
bool TextureManager::Draw( glm::mat4 persp,glm::mat4 cam, int x, int y, glm::vec4 fbCol, glm::vec4 normCol )
{
	//glBindRenderbuffer
	//To render to tex2d->
	glBindTexture(GL_TEXTURE_2D, m_frameTexture);
	...
	if(!RenderEngine::Draw(persp, cam)) return false;
...
bool TextureManager::BindExtraImageByID(GLuint id, int texIndex)
{
	return false;
}
