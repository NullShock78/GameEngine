...
typedef struct { glm::vec3 v, n; } VertNorm;
enum SphereDefines
{
...
public:
	...
	static void MakeNormaledPlane(GraphicalObject * gob);
	...
	static bool CreatePlane(GraphicalObject * gob, glm::vec2 upperL, glm::vec2 lowerR, glm::vec3 tint);
	//static bool CreatePlane(GraphicalObject * gob, glm::vec3 upperL, glm::vec3 lowerR, glm::vec3 tint = glm::vec3(1.0f,0.0f,1.0f));
private:
	...
	static float normal_plane_normVerts[36];
	static VertNorm generated_plane_normVerts[6];
