...
private:
	...
	GraphicalObject * m_nextCollider{ nullptr };
public:
	...
	GraphicalObject * GetNextCollider();
	~GraphicalObject();
	...
	void SetNextCollider(GraphicalObject * gob);
	...
	glm::mat4 GetTranslateMatFromPos();
