...
public:
	...
	glm::mat4 GetWorldToViewMatrix(glm::vec3 pos);
	glm::mat4 GetReflectionToViewMatrix();
	...
	glm::mat4 GetViewAt(glm::vec3 pos);
	void Reflect(glm::vec3 otherCameraDir, bool negative = true);

	void Reflect2(glm::vec3 otherCameraDir);

	glm::vec3 GetPosition();
	glm::vec3 GetRight();

	glm::mat4 GetViewWithRot(float rot);
