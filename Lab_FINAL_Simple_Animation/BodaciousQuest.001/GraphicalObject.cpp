...
void GraphicalObject::Enable()
{
	m_enabled = true;
}

void GraphicalObject::Disable()
{
	m_enabled = false;
}

void GraphicalObject::SetEnabled(bool e)
{
	m_enabled = e;
}

bool GraphicalObject::GetEnabled()
{
	return m_enabled;
}
...
GraphicalObject * GraphicalObject::GetNextCollider()
{
	return m_nextCollider;
}
...
void GraphicalObject::SetNextCollider(GraphicalObject * gob)
{
	if (gob != this) {
		m_nextCollider = gob;
	}
	else {
		GameLogger::Log(LogMsgType::cProgrammerError, "GraphicalObject::SetNextCollider(): gob = this");
	}
}
...
void GraphicalObject::LookAtVec(glm::vec3 vec)
{
	//glm::vec3 pos = glm::vec3(0, 0, 0);
	//pos = glm::vec3(m_translateMat * glm::vec4(pos, 0.0f));
	//m_rotationMat = (glm::lookAt(point,  pos , glm::vec3(0, 1.0f, 0.0f)))*m_scaleMat;// glm::vec3(0, 1.0f, 0)
...
glm::mat4  GraphicalObject::GetTranslateMatFromPos()
{
